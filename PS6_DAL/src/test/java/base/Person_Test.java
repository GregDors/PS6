...
public class Person_Test {
	...
	@Test
	public void test_PersonDAL(){
		PersonDAL x = new PersonDAL();
		x.addPerson(person1);
		assertTrue(person1 == x.addPerson(person1));
		ArrayList<PersonDomainModel> y = new ArrayList<PersonDomainModel>();
		y.add(person1);
		assertTrue(y == x.getPersons());
		x.getPerson(person1UUID);
		assertTrue(person1 == x.getPerson(person1UUID));
		y.remove(person1);
		x.deletePerson(person1UUID);
		x.getPersons();
		assertTrue(y == x.getPersons());
		x.addPerson(person1);
		person1.setFirstName("John");
		x.updatePerson(person1);
		assertTrue(person1 == x.updatePerson(person1));
	}
